...
set (ProductVersionInputFilesPath "${PROJECT_SOURCE_DIR}/windows")
...
function(generate_product_version outfiles)
    ...
    if ("${PRODUCT_VERSION_REVISION}" STREQUAL "")
    ...
    configure_file(
        ${ProductVersionInputFilesPath}/VersionInfo.in
        ${_VersionInfoFile}
        @ONLY)
    configure_file(
        ${ProductVersionInputFilesPath}/VersionResource.rc
