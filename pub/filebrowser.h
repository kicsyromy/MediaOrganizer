...
MO_API  void file_browser_set_root_path(FileBrowser *browser, const gchar *path);
MO_API  void file_browser_change_directory(FileBrowser *browser, const gchar *directory_name);
